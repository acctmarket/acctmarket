...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["acctmarket.com"])
...
aws_s3_domain = AWS_S3_CUSTOM_DOMAIN or f"{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com"  # noqa
# STATIC & MEDIA
# ------------------------
STORAGES = {
    "default": {
...
MEDIA_URL = f"https://{aws_s3_domain}/media/"  # noqa
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="acctmarket <noreply@acctmarket.com>",
)
...
EMAIL_PORT = env("EMAIL_PORT")  # Use SSL port
